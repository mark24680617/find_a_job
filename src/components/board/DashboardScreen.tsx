 ...
 *
 * The route file is a server component that reads the sign-in cookie; this is the screen it
 * renders.
 */

export function DashboardScreen({ returning }: { returning: boolean }) {
  return (
    <AppShell signedOut={<Landing />} returning={returning}>
      <Dashboard />
    </AppShell>
  )
}
